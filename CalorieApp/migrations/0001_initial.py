# Generated by Django 3.1.7 on 2021-08-06 10:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('all_selected_food_today', models.ManyToManyField(related_name='invertory', to='CalorieApp.Food')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CalorieApp.profile')),
            ],
        ),
    ]
